...
# --- CONTEÚDO ATUALIZADO DOS ARQUIVOS ---
            ...
            <div class="card shadow-sm mb-4 border-0 rounded-3">
                ...
                <div class="card-body">
                    <form action="{{ url_for('add_service') }}" method="POST" class="mb-4">
                        <div class="mb-2">
                            <input type="text" class="form-control" name="name" placeholder="Nome do Serviço (ex: Corte)" required>
                        </div>
                        <div class="mb-2">
                            <input type="number" class="form-control" name="duration" placeholder="Duração (min)" required min="1">
                        </div>
                        <button type="submit" class="btn btn-primary w-100 fw-semibold">Adicionar Serviço</button>
                    </form>
                    <hr>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div>
                                ...
                                <small class="text-muted"><i class="bi bi-clock"></i> {{ service.duration }} min</small>
                            </div>
...
# --- OS DEMAIS ARQUIVOS PERMANECEM IGUAIS ---
...
def atualizar_arquivos():
    ...
    # Remove o banco de dados antigo para forçar recriação com campo de telefone
    if os.path.exists('agendamento.db'):
        os.remove('agendamento.db')
        print("Banco de dados antigo removido (Será recriado ao rodar o app).")
    ...
    print("\nSUCESSO! Sistema atualizado para a Versão com Telefone.")
