...
# --- TEMPLATES IGUAIS À VERSÃO ANTERIOR, APENAS ATUALIZANDO ---
                ...
                <div class="card-body">
                    <form action="{{ url_for('update_settings') }}" method="POST">
                        ...
                        <div class="row g-2 mb-3">
                            <div class="col-6"><label class="small text-muted">Abertura</label><input type="time" class="form-control form-control-sm" name="work_start" value="{{ establishment.work_start.strftime('%H:%M') }}" required></div>
                            <div class="col-6"><label class="small text-muted">Fechamento</label><input type="time" class="form-control form-control-sm" name="work_end" value="{{ establishment.work_end.strftime('%H:%M') }}" required></div>
                        </div>

                        <div class="row g-2 mb-3">
                            <div class="col-12"><label class="small text-muted fw-bold">Pausa de Almoço</label></div>
                            <div class="col-6"><label class="small text-muted">Início</label><input type="time" class="form-control form-control-sm" name="lunch_start" value="{{ establishment.lunch_start.strftime('%H:%M') if establishment.lunch_start else '' }}"></div>
                            <div class="col-6"><label class="small text-muted">Fim</label><input type="time" class="form-control form-control-sm" name="lunch_end" value="{{ establishment.lunch_end.strftime('%H:%M') if establishment.lunch_end else '' }}"></div>
                        </div>

                        <div class="mb-3"><label class="small text-muted">Seu Contato</label><input type="text" class="form-control form-control-sm" name="contact_phone" value="{{ establishment.contact_phone or '' }}"></div>
            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form id="scheduleForm" action="{{ url_for('create_appointment', url_prefix=establishment.url_prefix) }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6"><label class="form-label fw-semibold">Seu Nome</label><input type="text" class="form-control" name="client_name" required></div>
                            <div class="col-md-6"><label class="form-label fw-semibold">Seu Contato</label><input type="tel" class="form-control" name="client_phone" required></div>
                            <div class="col-12"><label class="form-label fw-semibold">Data</label><input type="date" class="form-control" id="appointment_date" name="appointment_date" required></div>
                            <div class="col-12"><label class="form-label fw-semibold">Horários</label>
